...
window.onload = function () {
    ...
    var video = $('#video1').videoCt({
        ...
        commentFile: '../../depend/comment.json'           //导入弹幕json数据
    });
    ...
    // 重新分配视频url，根据url传参
    var iVideo = document.getElementById('video1');
    var sVideo = document.getElementById('videoS');
    iVideo.src = sVideo.innerHTML;
