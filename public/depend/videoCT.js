...
$.fn.videoCt = function (options) {
    ...
    var defaults = {
        ...
        theme: 'blue',
        commentFile: '../../depend/comment.json'
    };
                ...
                var name = parseInt($videoCt[0].currentTime) + 1,
                    ...
                    $.ajax({
                        ...
                        data:{
                            ...
                            speed:speed,
                            action:action,
                            currentTime:intOpts.currentTime,
                        },
                        dataType:'json',
                        async:true,
                        success:addDM,
                    ...
                    function addDM(data)
                    {
                        ...
                        console.log(obj);
                        if (obj['msg'] == 'noLogin') {
                            alert('游客发送的弹幕不会与他人共享');
                            return false;
                        }
                        if (obj['msg'] == 'noAddDM') {
                            alert('您的账号当前的弹幕被屏蔽，请联系管理员');
                            return false;
                        }
                        if (obj['msg'] == 'noDM') {
                            alert('弹幕内容不能为空');
