<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/res/hres.html";i:1519741877;}*/ ?>
<!DOCTYPE html>
...
<!--heder end here-->
	...
	<ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="">视频回收站列表</a></li>
            </ol>
...
<!-- tab content -->
	<div class="container">
                ...
                <table class="table table-hover" style="font-weight: bold;margin-left:-20px;width:1000px;">
	                <thead>
	                	<tr>
	                		<th></th><th>ID</th><th>头像</th><th>姓名</th>

	                		<th>标题</th><th>内容</th><th>标签</th><th>时长</th><th>评论量</th><th>点击量</th><th>状态</th><th>操作1</th><th>操作</th>
	                	</tr>
	                </thead>
  				<tbody>
  					...
  					<tr>
		                ...
		                <td><img src="<?php echo $data['up_photo']; ?>" style="width:20px;height:20px"></td>
		                <td><?php echo $data['up_name']; ?></td>
		                <td><?php echo $data['title']; ?></td>
		                <td><?php echo $data['content']; ?></td>

		                <td><?php echo $data['label']; ?></td>
		                  <td><?php echo $data['time_long']; ?></td>
		               
		               
		                <td><?php echo $data['report_num']; ?></td>
		                <td><?php echo $data['click_num']; ?></td>
		                <td>
		                 <?php if($data['is_pass']==1): ?>
		                 已审核
		                 <?php else: ?>
		                 未审核
		                 <?php endif; ?>
		                ...
		                <td><a href="#" onclick="doDelete(<?php echo $data['id']; ?>)"   class="btn btn-link del"  type="button">恢复</a></td>
		                		               
		              
		                <td><a href="#" onclick="deletes(<?php echo $data['id']; ?>)"  class="btn btn-link del" type="button">删除</a></td> 
