<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:81:"/home/wwwroot/aishan.clwub.xin/public/../application/index/view/user/showmsg.html";i:1519741881;s:70:"/home/wwwroot/aishan.clwub.xin/application/index/view/layoutOther.html";i:1519797705;}*/ ?>
<!-- 
...
<!-- 完成-侧边菜单栏 -->
	...
	<div class="show-top-grids">
		<div class="userBox">
			<p class="title" style="color: #ED62ED; font-weight: bolder;"><?php echo $whoName; ?>的留言板</p>
			<!-- 留言编辑区 -->
			<div class="all-comments-info">
				...
				<script type="text/javascript">
					$('.msgBtn').on('click', function() {
						...
						$.ajax({
							type:'post',
							url:'/index/user/addMsg?whoID=' + <?php echo $whoID; ?>,
							data:{
								'content':myMsg,
							},
							dataType:'json',
						...
						$.ajax({
							type:'post',
							url:'/index/user/getMsg?whoID=' + <?php echo $whoID; ?>,
							data:{
								page:1,
							},
							dataType:'json',
