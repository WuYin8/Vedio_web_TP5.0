<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/liuyan/liuyan.html";i:1519741877;}*/ ?>
<!DOCTYPE html>
...
<!--heder end here-->
	...
	<ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="">留言展示列表</a></li>
            </ol>
...
<!-- tab content -->
	<div class="container">
                ...
                <table class="table table-hover" style="font-weight: bold;margin-left:-20px;width:1010px;">
	                <thead>
	                	<tr>

	                		<th></th><th>ID</th><th>userID</th><th>photo</th><th>name</th><th>content</th><th>create_Time</th><th>操作</th>
			...
			function getReports(data)
			{
				...
				for (var i = 0; i < obj['data'].length; i++) {
					...
					var str = 
						...
						"<td>" + obj['data'][i]['id'] + "</td>" +
						"<td>" + obj['data'][i]['user_id'] + "</td>" +
						"<td><img src='" + obj['data'][i]['photo'] + "' style='width: 50px; height: 50px;' /></td>" +
						"<td>" + obj['data'][i]['name'] + "</td>" +
						"<td>" + obj['data'][i]['content'] + "</td>" +
						"<td>" + obj['data'][i]['create_time'] + "</td>" +
						"<td><a href='#' onclick='deletes(" + obj['data'][i]['id'] + ")' class='btn btn-link del' type='button'>删除</a></td>";
					oTr.innerHTML = str;
				}
				// 把allpage的链接赋值到a标签上
				var oPage = obj['page'];
