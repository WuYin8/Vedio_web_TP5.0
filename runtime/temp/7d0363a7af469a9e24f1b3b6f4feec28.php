<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:83:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/report/hreport.html";i:1519741877;}*/ ?>
<!DOCTYPE html>
...
<div class="left-content">
	...
	<ol class="breadcrumb">
               <li class="breadcrumb-item"><a href="">评论回收站展示列表</a></li>
            </ol>
...
<!-- tab content -->
	<div class="container">
               ...
               <table class="table table-hover" style="font-weight: bold;margin-left:-25px;width:1010px;">
                <thead>
                	<tr>
                		<th></th><th>ID</th><th>userid</th><th>photo</th><th>username</th><th>count</th><th>create_time</th><th>状态</th><th>操作</th><th>操作</th>
                	</tr>
                </thead>
  				<tbody>
  					...
  					<tr>
		                ...
		                <td><img src="<?php echo $user['photo']; ?>" style="width: 50px; height:50px;" /></td>
		                ...
		                <td><?php echo $user['is_del']; ?></td>
		                
		                
		                		               
		               <!--  <td><a href="/admin/user/delete?id=<?php echo $user['id']; ?>" class="btn btn-link del" type="button">删除</a></td>  -->
		                <td><a href="#" onclick="deletes(<?php echo $user['id']; ?>)"  class="btn btn-link del" type="button">删除</a></td> 

		                <td><a href="#" onclick="doDelete(<?php echo $user['id']; ?>)"   class="btn btn-link del"  type="button">恢复</a></td>
