<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/user/gly.html";i:1519864697;}*/ ?>
<!DOCTYPE html>
...
<!-- Bootstrap Core CSS -->
<link href="/static/css1/bootstrap.min.css"
...
<!-- tab content -->
	<div class="container" style="margin-left:-20px; width:1035px;">
             <table  class="table table-hover" style="font-weight: bold;">
                <thead>
                	<tr >
                		<th></th><th>ID</th><th>name</th><th>phone</th><th>角色</th><th>操作</th>
  				<tbody>
          ...
          <?php endforeach; ?>
				...
				<a href="gly_Insert" class="btn btn-primary btn-lg active" id="button">增加</a>
