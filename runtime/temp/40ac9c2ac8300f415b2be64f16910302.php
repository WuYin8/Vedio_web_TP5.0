<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/aishan.clwub.xin/public/../application/index/view/notice/notice.html";i:1519741880;s:70:"/home/wwwroot/aishan.clwub.xin/application/index/view/layoutOther.html";i:1519797705;}*/ ?>
<!-- 
...
<!-- 完成-侧边菜单栏 -->
	...
	<script type="text/javascript">
		...
		$(function () {
			var timer = setInterval( function () {
				...
				if (i <= 0) {
					clearInterval(timer);
					$('.timer').html('正在跳转回首页……');
					$(location).prop('href', "<?php echo $url; ?>");
				}
			} , 1000);
		});
	</script>
		<div class="show-top-grids">
			<div class="msgBox">
				<div class="msg"><?php echo $msgUp; ?></div>
				<div class="timer">处理中……</div>
				<div class="msgUrl">
					<a href="<?php echo $url1; ?>"><?php echo $msg1; ?></a>
					或者
					<a href="<?php echo $url2; ?>"><?php echo $msg2; ?></a>
				</div>
			</div>
		</div>
