<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/report/report.html";i:1519814935;}*/ ?>
<!DOCTYPE html>
...
<!--heder end here-->
	...
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="">评论展示列表</a></li>
            </ol>
	...
	<div class="container">
                ...
                <thead>
                	<tr>
                		...
                		<th></th><th>ID</th><th>PHOTO</th><th>NAME</th><th>VIDEO</th><th>CONTENT</th><th>CREATE_TIME</th><th>操作</th><th></th>
				...
				for (var i = 0; i < obj['data'].length; i++) {
					...
					var str = 
						"<td><input type='checkbox'/></td>" + 
   	 						...
   	 						"<td><a href='/index/single/single?vid=" + obj['data'][i]['vedio_id'] + "'>戳这里看视频</a></td>" +
     							"<td>" + obj['data'][i]['content'] + "</td>" +
				              	"<td>" + obj['data'][i]['create_time'] + "</td>" +
				             	"<td><a href='#'' onclick='deletes(" + obj['data'][i]['id'] + ")' class='btn btn-link del' type='button'>放入回收站</a></td>";
					oTr.innerHTML = str;
				}
				// 把allpage的链接赋值到a标签上
				var oPage = obj['page'];
