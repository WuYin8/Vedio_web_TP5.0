<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/user/upper.html";i:1519863526;}*/ ?>
<!DOCTYPE html>
...
<!-- tab content -->
	<div class="container">
  <h1 class="page-header">修改角色权限 </h1>
        <div class="" id="addUser"  role="dialog" style='display: block' aria-labelledby="addUserModalLabel">
          <div class="" role="document" style="max-width:450px;">
            <form action="/admin/user/doupdate" method="post" autocomplete="off" draggable="false">
                <div class="">
                  <table class="table" style="margin-bottom:0px;">
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td width="80%"><input name="rname" value='<?php echo $rolename; ?>' disabled="" type="text" class="form-control" placeholder="角色名" name="truename" maxlength="10" autocomplete="off" /></td>
                      </tr>
                       <tr>
                        <td wdith="20%">添加权限:</td>
                        <td width="80%">
                              <?php if(!empty($pername)): foreach($pername as $val): if(empty($id[$val['authid']])): ?>
                              ...
                              <?php else: if($val['authid'] == $id[$val['pid']]['auth_id']): ?>
                                <input type="checkbox" value="<?php echo $val['id']; ?>" name="per[]" class="form-control" name="truename" checked maxlength="10" autocomplete="off" /><?php echo $val['auth_name']; ?><br>
