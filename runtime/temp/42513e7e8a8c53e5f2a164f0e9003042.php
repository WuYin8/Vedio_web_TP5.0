<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/home/wwwroot/aishan.clwub.xin/public/../application/admin/view/user/index.html";i:1519816855;}*/ ?>
<!DOCTYPE html>
...
<!-- tab content -->
	<div class="container" >
                ...
                <thead>
                	<tr>
                		<th></th><th>ID</th><th>头像</th><th>姓名</th><th>邮箱</th><th>手机号码</th><th>注册时间</th><th>
                		状态</th><th>禁用</th><th>启用</th><th>操作</th>
                	</tr>
                </thead>
  				<tbody>
  					...
  					<tr>
		                ...
		                <?php endif; ?>
		                 ...
		                 <td><a href="#" class="btn btn-link" type="button" onclick="stop(<?php echo $user['id']; ?>)">禁用</a></td>
		                 <td><a href="#" class="btn btn-link" type="button" onclick="start(<?php echo $user['id']; ?>)">启用</a></td>
          ...
          <?php endforeach; ?>
					...
					<button class="btn btn-default">全不选</button>
					<button class="btn btn-default">反选</button>
