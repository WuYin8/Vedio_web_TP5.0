<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:82:"/home/wwwroot/aishan.clwub.xin/public/../application/index/view/search/search.html";i:1519741880;s:70:"/home/wwwroot/aishan.clwub.xin/application/index/view/layoutOther.html";i:1519797705;}*/ ?>
<!-- 
...
<!-- 完成-侧边菜单栏 -->
	...
	<div class="main-grids">
		<div class="top-grids">
			<!-- 搜索结果 -->
			<p class="glyphicon glyphicon-blackboard" style="font-size: 30px;background-color: #f7f7f7;50px; width: 100%; padding: 10px 0 10px 10px; box-shadow: 2px 2px 2px #cdcdcd;">&nbsp;"<?php echo $sWord; ?>"的搜索结果</p>
			<!-- 搜索频道名称 -->
			...
			<?php else: foreach($class as $vClass): ?>
					<button class="btnClass" id="<?php echo $vClass['id']; ?>"><?php echo $vClass['name']; ?></button>
